...
class Controller_Mail extends Tmis_Controller {
	...
	function actionRight() {
		...
		$tpl = 'TblList.tpl'; 
		// /////////////////////////////表头
		$arr_field_info = array('_edit' => array('text' => "<input type='checkbox' id='sel' ext:qtip='全选/反选'>", 'width' => 40), 
			// 'isRead'=>'状态',
			"Sender.realName" => '发送人',
		...
		if (count($rowset) > 0) foreach($rowset as &$v) {
			...
			$v['title'] = "<a href='" . $this->_url('ViewDetails', array('id' => $v['id'],
					'TB_iframe' => 1,
					'no_edit' => 1
	...
	function actionRemoveByAjax() {
		...
		echo json_encode(array('success' => $success, 'msg' => '删除失败'));
		exit;
	}
}
