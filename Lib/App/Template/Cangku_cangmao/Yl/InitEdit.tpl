	...
	<form name="form1" id="form1" action="{url controller=$smarty.get.controller action='save'}" method="post">
		...
		<fieldset style="border:0px;">     
			...
			<table  id='table_moreinfo' class="tableHaveBorder" style="width:400px;">
				...
				<tr>
					<td align="right" class="tdTitle">原料名称：</td>
					<td align="left">{webcontrol type='Select' name='ylId' itemName='原料' textName='ylCode' controller='Jichu_Yl' selected=$aRow.ylId}&nbsp;{$aRow.yls.ylName}&nbsp;{$aRow.yls.guige}</td></tr>
				<tr>
					<td align="right" class="tdTitle">原料数量：</td>
