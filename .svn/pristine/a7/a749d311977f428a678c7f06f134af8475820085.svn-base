...
<tr width="700"><td colspan="3" align="center" class="caption">{webcontrol type='GetAppInf' varName='compName'}{$title|default:'入库单'}</td></tr>
<tr> 
				<td class="tdItem">入库单号：{$arr_field_value.Ruku.cprkCode}</td>
				<td class="tdItem">&nbsp;</td>			
				<td class="tdItem" align="right">入库日期：{$arr_field_value.Ruku.cprkDate}</td>
  </tr>
	...
	<table class="tableHaveBorder" cellspacing="0" cellpadding="3">
		<tr class="th">
			...
			<tr align="center"> 
				...
				<td>{$arr_field_value.cntDuan|default:'&nbsp;'}</td>
