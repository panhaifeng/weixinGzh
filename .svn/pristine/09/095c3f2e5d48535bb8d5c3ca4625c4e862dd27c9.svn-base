 ...
 <Worksheet ss:Name="Sheet1">
  <Table x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">
    ...
    <Cell ss:StyleID="{if $align[1]=='right'}s25{else}s28{/if}"><Data ss:Type="{if $align[1]=='right'}Number{else}String{/if}">{if $key2==''}{$field_value.$key|default:''|escape:'html'}{elseif $key3==''}{$field_value.$key1.$key2|default:''|escape:'html'}{else}{$field_value.$key1.$key2.$key3|default:''|escape:'html'}{/if}</Data></Cell>
	{/foreach}
   </Row>
   {/foreach}
  </Table>
