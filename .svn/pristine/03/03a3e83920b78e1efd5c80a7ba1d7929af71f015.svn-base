...
class Model_Chengpin_Cpck2product extends TMIS_Model_Chengpin_Son {
    var $tableName = 'chengpin_cpck2product';
	var $primaryKey = 'id';
    ...
    var $belongsTo = array (
		...
		array(
			'tableClass' => 'Model_Chengpin_Cpck',
			'foreignKey' => 'chukuId',
			'mappingName' => 'Chuku'
		),
	);
